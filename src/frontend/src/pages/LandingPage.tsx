...
const features = [
  {
    ...
    description:
      "Mint your unique membership token on the Internet Computer. Immutable, verifiable, and truly yours.",
  ...
  },
  {
    ...
    title: "30-Day Trial",
    description:
      "Every new membership includes a full 30-day trial period to explore everything Actuality Studio has to offer.",
  ...
  },
  {
    ...
    description:
      "Powered by Internet Identity — no passwords, no email. Secure authentication built into the blockchain.",
      ...
      <section className="container mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <div className="max-w-3xl mx-auto text-center space-y-6 animate-fade-in">
          ...
          <div className="space-y-4 font-body text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            <p>
              Rudolf Steiner held that architecture is not merely one art among
              many — it is the primordial act of creation, the art that contains
              all others within its embrace.
            </p>
            <p>
              Actuality Studio is built upon this insight. We call this
              unfolding{" "}
              <em className="font-semibold text-foreground not-italic">
                The Sevenfold Arts
              </em>{" "}
              — a curriculum and a community where architecture, music, poetry,
              movement, sculpture, painting, drawing, and allied crafts are
              understood not as separate subjects but as one living organism of
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
              Actuality Studio is a members-only creative platform built on the
              Internet Computer. Authenticate with Internet Identity and mint
              your NFT membership to begin your journey into The Sevenfold Arts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl border flex items-center justify-center mb-4 transition-colors ${feature.iconBg}`}
                  >
