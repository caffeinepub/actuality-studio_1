    ...
    <section className="relative w-full overflow-hidden">
      <div className="relative w-full" style={{ aspectRatio: '1440/480' }}>
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/assets/generated/seasonal-leaf-vine-motif.dim_800x400.png')",
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-8 sm:px-16 lg:px-24">
          <div className="max-w-2xl animate-fade-in">
            ...
            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-light text-foreground leading-tight mb-4">
              Actuality
              <br />
              <span className="gradient-text-terracotta font-semibold">Studio</span>
            </h1>
            <p className="font-body text-base sm:text-lg text-muted-foreground max-w-md leading-relaxed">
              Rooted in Steiner's vision of architecture as the supreme synthesis —
              a living form from which all creative arts unfold.
            </p>
          </div>
        </div>
      </div>
